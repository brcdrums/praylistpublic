...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('PrayList_dailyprayer', (
            ...
            ('prayer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['PrayList.Prayer'])),
    ...
    models = {
        ...
        'PrayList.userprofile': {
            ...
            'saved_prayer_custom': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
