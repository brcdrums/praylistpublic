...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PrayedFor.prayed_user'
        db.add_column(u'PrayList_prayedfor', 'prayed_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'PrayedFor.prayer'
        db.add_column(u'PrayList_prayedfor', 'prayer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['PrayList.Prayer'], null=True),
                      keep_default=False)

        # Removing M2M table for field prayed_user_for on 'PrayedFor'
        db.delete_table('PrayList_prayedfor_prayed_user_for')

        # Removing M2M table for field prayer on 'PrayedFor'
        db.delete_table('PrayList_prayedfor_prayer')


    def backwards(self, orm):
        # Deleting field 'PrayedFor.prayed_user'
        db.delete_column(u'PrayList_prayedfor', 'prayed_user_id')

        # Deleting field 'PrayedFor.prayer'
        db.delete_column(u'PrayList_prayedfor', 'prayer_id')

        # Adding M2M table for field prayed_user_for on 'PrayedFor'
        db.create_table(u'PrayList_prayedfor_prayed_user_for', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('prayedfor', models.ForeignKey(orm[u'PrayList.prayedfor'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'PrayList_prayedfor_prayed_user_for', ['prayedfor_id', 'user_id'])

        # Adding M2M table for field prayer on 'PrayedFor'
        db.create_table(u'PrayList_prayedfor_prayer', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('prayedfor', models.ForeignKey(orm[u'PrayList.prayedfor'], null=False)),
            ('prayer', models.ForeignKey(orm[u'PrayList.prayer'], null=False))
        ))
        db.create_unique(u'PrayList_prayedfor_prayer', ['prayedfor_id', 'prayer_id'])
