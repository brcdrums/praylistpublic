...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SavedPrayerCustom.prayed_user'
        db.add_column('PrayList_savedprayercustom', 'prayed_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='deprecated', to=orm['auth.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'SavedPrayerCustom.prayed_user'
        db.delete_column('PrayList_savedprayercustom', 'prayed_user_id')
