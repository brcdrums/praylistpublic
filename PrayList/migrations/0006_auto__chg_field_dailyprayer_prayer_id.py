...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyPrayer.prayer_id'
        db.alter_column('PrayList_dailyprayer', 'prayer_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['PrayList.Prayer'], null=True))

    def backwards(self, orm):

        # Changing field 'DailyPrayer.prayer_id'
        db.alter_column('PrayList_dailyprayer', 'prayer_id_id', self.gf('django.db.models.fields.related.ForeignKey')(default='none', to=orm['PrayList.Prayer']))
    ...
    models = {
        'PrayList.dailyprayer': {
            ...
            'prayer_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['PrayList.Prayer']", 'null': 'True'}),
