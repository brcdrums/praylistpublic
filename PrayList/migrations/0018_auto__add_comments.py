...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'PrayList_comments', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prayer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['PrayList.Prayer'])),
            ('body', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('posted_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('edited_on', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['PrayList.Comments'], null=True)),
        ))
        db.send_create_signal(u'PrayList', ['Comments'])


    def backwards(self, orm):
        # Deleting model 'Comments'
        db.delete_table(u'PrayList_comments')
    ...
    models = {
        u'PrayList.comments': {
            ...
            'edited_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['PrayList.Comments']", 'null': 'True'}),
            'posted_on': ('django.db.models.fields.DateTimeField', [], {}),
            'prayer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['PrayList.Prayer']"}),
