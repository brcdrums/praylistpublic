...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailyPrayer.saved_prayer_custom'
        db.add_column('PrayList_dailyprayer', 'saved_prayer_custom',
    ...
    def backwards(self, orm):
        # Deleting field 'DailyPrayer.saved_prayer_custom'
        db.delete_column('PrayList_dailyprayer', 'saved_prayer_custom_id')
